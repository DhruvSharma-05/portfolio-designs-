...
export const AboutSection: React.FC<AboutSectionProps> = ({ onContactClick }) => {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] text-[#D7E2EA] overflow-hidden select-none"
    >
      {/* Decorative 3D Image 1: Top-Left Moon Icon */}
      <div className="absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%] z-0 pointer-events-none">
        <FadeIn delay={0.1} x={-80} y={0} duration={0.9}>
          <img
            src="https://shrug-person-78902957.figma.site/_components/v2/ebb2b8f25d8e24d5f0a5ca8af4c950de81aa2fd7/moon_icon.11395d36.png"
            alt="3D Moon Icon"
            className="w-[120px] sm:w-[160px] md:w-[210px] h-auto object-contain opacity-90 drop-shadow-xl"
            loading="lazy"
          />
        </FadeIn>
      </div>

      {/* Decorative 3D Image 2: Bottom-Left 3D Object */}
      <div className="absolute bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%] z-0 pointer-events-none">
        <FadeIn delay={0.25} x={-80} y={0} duration={0.9}>
          <img
            ...
            className="w-[100px] sm:w-[140px] md:w-[180px] h-auto object-contain opacity-90 drop-shadow-xl"
            loading="lazy"
          />
        </FadeIn>
      </div>

      {/* Decorative 3D Image 3: Top-Right Lego Icon */}
      ...
      {/* Decorative 3D Image 4: Bottom-Right 3D Group */}
      <div className="absolute bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%] z-0 pointer-events-none">
        <FadeIn delay={0.3} x={80} y={0} duration={0.9}>
          <img
            src="https://shrug-person-78902957.figma.site/_components/v2/ebb2b8f25d8e24d5f0a5ca8af4c950de81aa2fd7/Group_134-1.2e04f3ce.png"
            alt="3D Group Icon"
            className="w-[130px] sm:w-[170px] md:w-[220px] h-auto object-contain opacity-90 drop-shadow-xl"
            loading="lazy"
          />
        </FadeIn>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-4xl text-center">
        ...
        <div className="mb-16 sm:mb-20 md:mb-24 max-w-[560px]">
          <AnimatedText
            text={textContent}
