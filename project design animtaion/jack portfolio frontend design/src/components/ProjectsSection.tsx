...
export const ProjectsSection: React.FC<ProjectsSectionProps> = ({ onLiveProjectClick }) => {
  return (
    <section
      id="projects"
      className="relative z-20 bg-[#0C0C0C] text-[#D7E2EA] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] -mt-10 sm:-mt-12 md:-mt-14 px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32 w-full"
    >
