...
/* ==================================================================
   ...
   meshes) with normal blending + an ink colour so they read on the
   light bio section rather than glowing on black.
...
const DEFAULTS = {
  particlesCount: 6870,
  particleScale: 2,   // dot size multiplier
  ...
  color: "#191f25",   // ink — reads on the cream section
  drag: true,
};
